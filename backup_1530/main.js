...
const offsets = [
  { value: "-12:00", label: "UTC-12:00 베이커섬(미국령)", img: "images/flags/the_United_States.png" },
  { value: "-11:00", label: "UTC-11:00 사모아(파고파고)", img: "images/flags/American_Samoa.png" },
  { value: "-10:00", label: "UTC-10:00 미국(하와이)", img: "images/flags/Hawaii.png" },
  { value: "-09:00", label: "UTC-09:00 미국(알래스카)", img: "images/flags/Alaska.png" },
  { value: "-08:00", label: "UTC-08:00 미국(LA)", img: "images/flags/the_United_States.png" },
  { value: "-07:00", label: "UTC-07:00 미국(덴버)", img: "images/flags/the_United_States.png" },
  { value: "-06:00", label: "UTC-06:00 미국(시카고)", img: "images/flags/the_United_States.png" },
  { value: "-05:00", label: "UTC-05:00 미국(뉴욕)", img: "images/flags/the_United_States.png" },
  { value: "-04:00", label: "UTC-04:00 칠레(산티아고)", img: "images/flags/Chile.png" },
  { value: "-03:00", label: "UTC-03:00 아르헨티나(부에노스아이레스)", img: "images/flags/Argentina.png" },
  { value: "-01:00", label: "UTC-01:00 카보베르데(프라이아)", img: "images/flags/Cape_Verde.png" },
  { value: "+00:00", label: "UTC+00:00 영국(런던)", img: "images/flags/the_United_Kingdom.png" },
  { value: "+01:00", label: "UTC+01:00 알제리(알제)", img: "images/flags/Algeria.png" },
  { value: "+02:00", label: "UTC+02:00 이집트(카이로)", img: "images/flags/Egypt.png" },
  { value: "+03:00", label: "UTC+03:00 탄자니아(다르에스살람)", img: "images/flags/Tanzania.png" },
  { value: "+03:30", label: "UTC+03:30 이란(테헤란)", img: "images/flags/Iran.png" },
  { value: "+04:00", label: "UTC+04:00 아랍에미리트(두바이)", img: "images/flags/the_United_Arab_Emirates.png" },
  { value: "+04:30", label: "UTC+04:30 아프가니스탄(카불)", img: "images/flags/the_Taliban.png" },
  { value: "+05:00", label: "UTC+05:00 파키스탄(이슬라마바드)", img: "images/flags/Pakistan.png" },
  { value: "+05:30", label: "UTC+05:30 인도(뉴델리)", img: "images/flags/India.png" },
  { value: "+05:45", label: "UTC+05:45 네팔(카트만두)", img: "images/flags/Nepal.png" },
  { value: "+06:00", label: "UTC+06:00 방글라데시(다카)", img: "images/flags/Bangladesh.png" },
  { value: "+06:30", label: "UTC+06:30 미얀마(양곤)", img: "images/flags/Myanmar.png" },
  { value: "+07:00", label: "UTC+07:00 태국(방콕)", img: "images/flags/Thailand.png" },
  { value: "+08:00", label: "UTC+08:00 중국(베이징)", img: "images/flags/the_People's_Republic_of_China.png" },
  { value: "+09:00", label: "UTC+09:00 대한민국(서울)", img: "images/flags/South_Korea.png" },
  { value: "+09:30", label: "UTC+09:30 호주(애들레이드)", img: "images/flags/Australia.png" },
  { value: "+10:00", label: "UTC+10:00 호주(시드니)", img: "images/flags/Australia.png" },
  { value: "+11:00", label: "UTC+11:00 솔로몬제도(호니아라)", img: "images/flags/Solomon_Islands.png" },
  { value: "+12:00", label: "UTC+12:00 뉴질랜드(오클랜드)", img: "images/flags/New_Zealand.png" },
  { value: "+13:00", label: "UTC+13:00 사모아(아피아)", img: "images/flags/Samoa.png" },
  { value: "+14:00", label: "UTC+14:00 키리바시(라인제도)", img: "images/flags/Kiribati.png" }
];
...
function buildMapCustomSelect() {
  ...
  offsets.forEach((o, idx) => {
    // UTC와 도시명 분리
    let labelParts = o.label.split(" ");
    let utcPart = labelParts[0];
    let cityPart = labelParts.slice(1).join(" ");
    
    const el = document.createElement('div');
    el.innerHTML = `<span>${utcPart}</span>
    ...
    // 첫 진입(한국) 초기화
    if(o.value === "+09:00") selected.innerHTML = el.innerHTML;
  });
